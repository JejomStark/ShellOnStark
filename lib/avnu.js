...
import { getWalletPortfolio } from './wallet.js';
import * as dotenv from "dotenv";
import { formatAmountInWallet } from './utils.js';
dotenv.config();
...
async function performSwap(swapInfo, tokens) {
    try {
        ...
        // Swap Execution
        // slippage 0.5%
        const res = await executeSwap(account, quotes[0], {slippage: 0.01}, AVNU_OPTIONS);
